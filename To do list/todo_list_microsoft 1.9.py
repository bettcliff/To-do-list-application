...
class ModernToDoList:
    ...
    def create_modern_sidebar(self):
        ...
        # Profile section
        profile_frame = ttk.Frame(sidebar, style="Modern.TFrame")
        ...
        for category, icon in categories:
            btn = ttk.Button(
                ...
                style="Modern.TButton",
                command=lambda c=category: self.show_page(c)
            )
    ...
    def create_modern_content(self):
        ...
        # Header with search
        header = ttk.Frame(content, style="Modern.TFrame")
        ...
        # Task input section with modern styling
        input_frame = ttk.Frame(content, style="Modern.TFrame")

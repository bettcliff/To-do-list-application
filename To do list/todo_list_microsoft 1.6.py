...
class CategoryPage(ttk.Frame):
    def __init__(self, parent, category_name, main_app):
        ...
        style.configure('Task.TEntry', fieldbackground='#404040', foreground='white')
    ...
    def create_tasks_list(self):
        # Tasks container with dark theme
    ...
    def create_completed_tasks_list(self):
        # Completed tasks container with dark theme
        completed_frame = ttk.Frame(self, style='Dark.TFrame')
    ...
    def create_context_menu(self):
        self.context_menu = tk.Menu(self, tearoff=0, bg='#404040', fg='white')
        if self.category_name == "My Day":
    ...
    def edit_task(self):
        ...
        if selected:
            ...
            ttk.Label(edit_window, text="Task:", style='Dark.TLabel').pack(pady=5)
            task_entry = ttk.Entry(edit_window, width=40, style='Task.TEntry')
            task_entry.insert(0, values[1])
            task_entry.pack(pady=5)
            
            ttk.Label(edit_window, text="Due Date:", style='Dark.TLabel').pack(pady=5)
...
class DashboardPage(ttk.Frame):
    ...
    def create_dashboard(self):
        ...
        graphs_frame = ttk.Frame(self, style='Dark.TFrame')
        graphs_frame.pack(fill="both", expand=True, padx=20)
        
        # Create left and right frames for graphs
        left_frame = ttk.Frame(graphs_frame, style='Dark.TFrame')
        left_frame.pack(side="left", fill="both", expand=True)
        
        right_frame = ttk.Frame(graphs_frame, style='Dark.TFrame')
    ...
    def create_completion_pie_chart(self, parent):
        ...
        # Modern title
        plt.title("Task Completion Status", pad=20, color='white')
...
class ModernToDoList:
    ...
    def setup_main_container(self):
        # Modern sidebar
        sidebar = ttk.Frame(self.root, style='Dark.TFrame')
        ...
        # Main content area
        self.content_frame = ttk.Frame(self.root, style='Dark.TFrame')
